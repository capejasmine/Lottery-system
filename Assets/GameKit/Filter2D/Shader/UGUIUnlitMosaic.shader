...
Shader "_Game/Filter2D/UGUI Mosaic"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			{
				#ifdef MOSAICTYPE_ON
				fixed4 color = mosaic2(_MainTex,IN.texcoord,half2(_TexSizeX,_TexSizeY),half2(_MosaicSizeX,_MosaicSizeY));
				#else
				fixed4 color = mosaic1(_MainTex,IN.texcoord,half2(_TexSizeX,_TexSizeY),half2(_MosaicSizeX,_MosaicSizeY));
				#endif
