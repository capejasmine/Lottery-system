...
Shader "_Game/ImageProcess/Tender" { 
		Properties{
			...
			_TenderCurve("Tender Curve Texture",2D) = "Transparent" {}
			_GreyFrame("Grey Frame",2D) = "Transparent" {}
		}
		...
		SubShader{
			...
			fixed4 frag(v2f i) : COLOR
			{
				...
				col = doTender(col,_TenderCurve,_GreyFrame,i.texcoord);

				//float4 doTender(_MainTex,_TenderCurve,_GreyFrame,i.texcoord);
