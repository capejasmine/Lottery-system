...
Shader "_Game/ImageProcess/Sakura" { 
		Properties{
			...
			_SakuraCurveTex("Curve Texture",2D) = "Transparent" {}
		}
		...
		SubShader{
			...
			fixed4 frag(v2f i) : COLOR
			{
				...
				col = doSakura(col,_MainTex,_SakuraCurveTex,i.texcoord);
				return col;
			}
