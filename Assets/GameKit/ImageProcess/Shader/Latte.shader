...
Shader "_Game/ImageProcess/Latte" { 
		Properties{
			...
			_LatteCurveTex("Curve Texture",2D) = "Transparent" {}
		}
		...
		SubShader{
			...
			fixed4 frag(v2f i) : COLOR
			{
				...
				col = doLatte(col,_LatteCurveTex,i.texcoord);

//					float4 col = doLatte(_MainTex,_LatteCurveTex,i.texcoord);
				return col;
			}
