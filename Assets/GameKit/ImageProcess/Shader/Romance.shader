...
Shader "_Game/ImageProcess/Romance" { 
		Properties{
			...
			_RomanceCurveTex("Curve Texture",2D) = "Transparent" {}
		}
		...
		SubShader{
			...
			fixed4 frag(v2f i) : COLOR
			{
				...
				col = doRomance(col,_RomanceCurveTex,i.texcoord);
//					float4 col = doRomance(_MainTex,_RomanceCurveTex,i.texcoord);
				return col;
			}
