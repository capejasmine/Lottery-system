...
//结合SpriteMask.cs使用
Shader "_Game/Mask/Sprite Mask By Texture"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert(appdata_t IN)
			{
                ...
                if (_MaskType==1){
                	OUT.maskUV = GetMaskUV(IN.vertex,_MaskClip.zw,_MaskClip.xy).zw;
                }else if(_MaskType==2){
                	OUT.maskUV = GetMaskUV1(IN.vertex,_MaskClip.zw,_MaskClip.xy).zw;
                }
